...
const compactProjects = [
  ...
  },
  {
    ...
    github:
      'https://github.com/Frax404NF/Belajar-Dasar-Pemrograman-Web-Submission',
  },
]
          ...
          <div>
            ...
            >
              <a
                ...
                className="link-accent work-link"
              >
                GitHub <ExternalIcon />
              </a>
              <a
                href={featuredProject.docs}
                target="_blank"
                rel="noopener noreferrer"
        ...
        >
          {secondaryProjects.map((project, i) => (
            <div
              key={project.name}
              className={
                i === 0 ? 'work-secondary-wide' : 'work-secondary-narrow'
              }
            >
              <h3
                style={{
