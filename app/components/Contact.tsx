...
const contactLinks = [
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/frandi-andika-30a505260/',
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: 'frandispacetb@gmail.com',
    href: 'mailto:frandispacetb@gmail.com',
    icon: (
    ...
    <section id="contact" aria-labelledby="contact-heading" style={{ background: 'var(--color-bg-subtle)', padding: '96px 0', fontFamily: 'var(--font-sans)' }}>
      ...
      >
        ...
        <h2
          ...
          style={{ fontSize: 'var(--text-2xl)', fontWeight: 600, color: 'var(--color-text-primary)', lineHeight: 1.2, letterSpacing: '-0.02em', margin: '0 0 0.5rem', animationDelay: '60ms' }}
        >
          Let&apos;s work together.
        </h2>
        ...
        <p
          className={`animate-fade-up${inView ? ' in-view' : ''}`}
          style={{ fontSize: 'var(--text-base)', color: 'var(--color-text-muted)', margin: '0 0 2.5rem', animationDelay: '120ms' }}
        >
        ...
        <div
          className={`animate-fade-up${inView ? ' in-view' : ''}`}
          style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap', alignItems: 'center', animationDelay: '180ms' }}
        >
